...
func main() {
	...
	server := grpc.NewServer(grpc.ChainUnaryInterceptor(interceptors.ResponseTimeInterceptors, interceptors.NewRateLimiter(5, time.Minute).RateLimiterInterceptor, interceptors.AuthenticationInterceptor))
