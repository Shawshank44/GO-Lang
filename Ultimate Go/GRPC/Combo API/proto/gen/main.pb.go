...
func (x *HelloRespoonse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HelloRespoonse) ProtoMessage() {}

func (x *HelloRespoonse) ProtoReflect() protoreflect.Message {
	mi := &file_main_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HelloRespoonse.ProtoReflect.Descriptor instead.
func (*HelloRespoonse) Descriptor() ([]byte, []int) {
	return file_main_proto_rawDescGZIP(), []int{1}
}

func (x *HelloRespoonse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_main_proto_goTypes = []any{
	...
	(*HelloRespoonse)(nil), // 1: main_api.HelloRespoonse
}
var file_main_proto_depIdxs = []int32{
	0, // 0: main_api.Greeter.Greet:input_type -> main_api.HelloRequest
	1, // 1: main_api.Greeter.Greet:output_type -> main_api.HelloRespoonse
